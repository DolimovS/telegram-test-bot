...
O‘quvchi `482731 ABCD` yoki `482731 1-A, 2-B, 3-C, 4-D` formatida kod va barcha javoblarni bitta xabarda yuboradi. Tasdiqlash 30 daqiqa amal qiladi. Har testga bitta yakuniy topshirish; qayta topshirish va tahrir yo‘q. Natijada ball va xato savollar raqami ko‘rsatiladi, kalit oshkor qilinmaydi. Kechiktirilgan natijalar tarixda ham yopiq qoladi. Bot yopilganda natijalarni xabarda yuborishga urinadi; tarixdan ham ko‘rish mumkin.
